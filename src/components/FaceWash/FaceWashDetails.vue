  ...
  data() {
    return {
      ...
      },
      {
        ...
        whatsappLink: 'https://wa.me/9092627921?text=Hello, I am interested in buying Skin Therapy Cleansing Oil Face.'
      },
      {
      ...
      },
      {
        ...
        whatsappLink: 'https://wa.me/9092627921?text=Hello, I am interested in buying ACNE CONTROL Glow Face Wash.'
      },
      {
